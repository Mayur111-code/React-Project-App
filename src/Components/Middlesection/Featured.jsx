...
import Carddata from '../../assets/Cardsdata';
const Featured = () => {
    return(
   <>
      <section className="py-5">
        <div className="container text-center">
          <h2 className="fw-bold mb-5">Featured Properties</h2>
        </div>
      </section>
              ...
              <div className="card shadow-sm h-100">
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span
                      className={`badge ${
                        property.priceType === "Sale" ? "bg-success" : "bg-danger"
                      }`}
                    >
                      {property.priceType}
                    </span>
