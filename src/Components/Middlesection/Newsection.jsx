...
//         <h2 className="fw-bold mb-5" data-aos="zoom-in">Explore Our Categories & Places</h2>
    ...
    <>
      <section className="py-5">
        <div className="container text-center">
          ...
          <div className="row mb-5">
            <div className="col-md-3 col-6 mb-3" data-aos="zoom-in">
              <div className="p-4 border bg-light">
                <FaTree size={80} color="green" />
                <h6>Land</h6>
              </div>
            ...
            <div className="col-md-3 col-6 mb-3" data-aos="zoom-in" data-aos-delay="100">
              <div className="p-4 border bg-light">
                <FaHome size={80} color="green" />
                <h6>Residential</h6>
              </div>
            ...
            <div className="col-md-3 col-6 mb-3" data-aos="zoom-in" data-aos-delay="200">
              <div className="p-4 border bg-light">
                <FaBuilding size={80} color="green" />
                <h6>Commercial</h6>
              </div>
            ...
            <div className="col-md-3 col-6 mb-3" data-aos="zoom-in" data-aos-delay="300">
              <div className="p-4 border bg-light">
                <FaIndustry size={80} color="green" />
                <h6>Industrial</h6>
              </div>
          ...
          <div className="row">
            {places.map((place, index) => (
              ...
              >
                <h6 className="fw-bold">{place.name}</h6>
                <p className="text-success">{place.properties} Properties</p>
              </div>
            ))}
          </div>
        </div>
